...
- 리포지토리: `jangre` (장르 — 다양한 앱 장르 탐색)
- 주제 후보: 습관 트래커 / 플래시카드 암기 앱 / 텍스트 RPG
- 플랫폼: 모바일 앱 우선 (Flutter / React Native / 네이티브)
...
.planning/decisions/ADR-0001-*.md    # 플랫폼 선택 근거
.planning/decisions/ADR-0002-*.md    # 상태 관리 방식
.planning/decisions/ADR-0003-*.md    # 데이터 저장 방식
```
